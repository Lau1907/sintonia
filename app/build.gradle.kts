...
// Carga la propiedad directamente desde local.properties mediante la API de Gradle
val youtubeApiKey: String = providers.gradleProperty("YOUTUBE_API_KEY").getOrElse("")
